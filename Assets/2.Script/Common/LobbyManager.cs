...
public class LobbyManager : MonoBehaviour
{
    ...
    6. 유저 id 기반으로 게임 세이브, 로드 기능 만들기. (로드 데이터를 기반으로 맵로드 기능 제작하기.)

    수정 해야할 것 : 맵로드 기능 수정 (SaveObject클래스를 이용한 불러오기할 때 연관된 오브젝트들은 하나로 줄이기. 계단 2개 하나만 적용하고 bool값은 부정을 이용해 적용하기.)
    이를 위해 퀘스트 성공후 변화하는 오브젝트에 SaveObject 스크립트 제거
    */
}
