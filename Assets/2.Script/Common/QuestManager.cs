...
public class QuestManager : Singleton<QuestManager>
{
    ...
    public void QuestCheck(string key, string creditType, int credit, IQuest quest, BoxCollider2D col = null) //플레이어 미션, 미션 키 업데이트, 미션에 필요한 크레딧 저장, 미션을 반응하게 하는 콜라이더 저장.
    {
